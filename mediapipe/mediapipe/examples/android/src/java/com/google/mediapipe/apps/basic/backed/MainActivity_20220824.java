...
public class MainActivity extends AppCompatActivity {
  ...
  private static float landMarksData[][] = new float[33][3];
...
*/
  ...
  private static String getPoseLandmarksDebugString(LandmarkList poseLandmarks) {
	...
	landMarksData[landmarkIndex][0]= Float.valueOf(landmark.getX()).floatValue();
	landMarksData[landmarkIndex][1]= Float.valueOf(landmark.getY()).floatValue();
	landMarksData[landmarkIndex][2]= Float.valueOf(landmark.getZ()).floatValue();
